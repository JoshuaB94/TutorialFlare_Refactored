        ...
        <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-md">
            <img
              ...
              alt="Workflow"
            />
            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Login to Tutorial Flare</h2>
            <p className="mt-2 text-center text-sm">
              <a href="/" className="font-medium text-zinc-600 hover:text-orange-600">
                Back to Home
              </a>
            </p>
          </div>
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
              ...
              <div className="mt-6">
                ...
                <div className="mt-6 "> 
                  {/* Implement Later: grid grid-cols-3 gap-3 */}
                  {/* <div>
                    <a
                      href="#"
